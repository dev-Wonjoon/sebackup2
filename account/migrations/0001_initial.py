# Generated by Django 4.0.3 on 2022-06-14 07:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ull_user_pk', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='PlatformToUser', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='AuthLog',
            fields=[
                ('auth_seq', models.AutoField(primary_key=True, serialize=False)),
                ...
                ('auth_user_pk', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='AuthLogToUser', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
